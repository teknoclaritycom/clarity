                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                class="form-control bg-dark text-light text-center"
                             placeholder="Masukkan Harga" wire:model="price">
                        </div>
                        <div class="mb-4">
                            <label 
                                class="block text-gray-700 text-sm font-bold mb-2">Nomor WA:</label>
                            <input type="text"
                                class="form-control bg-dark text-light text-center"
                             placeholder="Masukkan Nomor WhatsApp" wire:model="nomorwa">
                        </div>
