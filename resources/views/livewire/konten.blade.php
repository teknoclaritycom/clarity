          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <span class="text-white text-capitalize ps-3">Artikel Terbaru</span>
                <button class="btn btn-success btn-sm mt-3" wire:click="create()">Tambah Artikel</button>
            @if($isModalOpen)
                    ...
                    <tr>
                      ...
                      <td class="align-middle"><div>
                        <button class="btn btn-link text-secondary mb-0">
                          <a href="https://irvanjaya.id/blog/{{$konten->slug}}"><i class="fa fa-eye"></i> Lihat</a>
                        </button>
